...
ui <- fluidPage(
  ...
  # Application title
  titlePanel("Ecological Site Summary Tool"),
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      selectInput(inputId = "variable",
                  label = "Indicator(s) to plot",
                  variable = TRUE,
                  choices = c("")),
      selectInput(inputId = "grouping_variable",
                label = "Variable to group Terradat data e.g. ecological site",
                value = "",
                placeholder = c("Ecological Site", "Use Look up csv"),
      hr(),
      
      # If you want to compare all data to a single plot that is within the csv/fetch command
      conditionalPanel(condition = "grouping_variable == 'Use Look up csv'",
                       checkboxInput(inputId = "lut_csv",
                                     label = "CSV containing look up table for Primarykey and Grouping variable",
                                     multiple = FALSE,
                                     accept = "CSV")),
