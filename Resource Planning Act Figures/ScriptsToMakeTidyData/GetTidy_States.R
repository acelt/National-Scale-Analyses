...
estimates <- paste0(path, "2020 Estimates\\2020 Estimates by State by Type.csv")
...
# bind 2020 data to previous years
fulldataset_allyears <- rbind(FullYears, fulldata_withlabels)

write.csv(fulldataset_allyears, paste0(path, "EstimatesByStateByType_2012_", Year, "_withlabels.csv"), row.names = FALSE)
